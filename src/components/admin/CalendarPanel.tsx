...
/**
 * Connect or disconnect your own Google or Apple calendar.
 *
 * Shared between the standalone /calendar page and the admin Settings tab —
 * one person, one set of connections, so it is one component rather than two
 * copies of the same connect/disconnect logic.
 */
